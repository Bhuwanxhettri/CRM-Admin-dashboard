...
const SignIn = () => {
  ...
  const handleSubmit = () => {
    ...
    if (inputs.email == "" || inputs.password == "") {
      if (inputs.email === "") {
        setErrmassage({ email: "Field required" });
        return;
      }
      if (inputs.password === "") {
        setErrmassage({ password: "Filed is required" });
        return;
      }
    } else {
      dispatch(actions.login(inputs));
    }
  };
              ...
              <div className="mt-12">
                <div>
                  <div>
                    ...
                    />
                    <span className="text-red-500">{errmessage.email}</span>
                  </div>
                  <div className="mt-8">
                    ...
                    />
                    <span className="text-red-500">{errmessage.password}</span>
                  </div>
                  <div className="mt-10">
                    <button
